...
insert into users (id, username, password, email, address, phoneNum, dateOfBirth, typeId, status) values (2, 'min', '123', 'rlogan1@gravatar.com', '06 Pawling Place', '118-490-6237', '2020-12-20', 1, true);
...
insert into users (id, username, password, email, address, phoneNum, dateOfBirth, typeId, status) values (6, 'Brose', 'DceBmspf4', 'bmcaneny5@w3.org', '24 Anniversary Parkway', '308-501-9856', '2020-12-20', 1, false);
insert into users (id, username, password, email, address, phoneNum, dateOfBirth, typeId, status) values (7, 'Rhodie', 'D5kpOig', 'rmerigon6@bluehost.com', '7117 Banding Terrace', '691-174-9741', '2020-12-20', 1, false);
insert into users (id, username, password, email, address, phoneNum, dateOfBirth, typeId, status) values (8, 'Marin', 'GfBP2rM', 'mlots7@webeden.co.uk', '7826 Heffernan Pass', '835-933-9589', '2020-12-20', 1, false);
insert into users (id, username, password, email, address, phoneNum, dateOfBirth, typeId, status) values (9, 'Carin', 'JUvtWWx7J', 'cgoodrick8@chicagotribune.com', '65 Logan Hill', '113-930-3412', '2020-12-20', 1, false);
